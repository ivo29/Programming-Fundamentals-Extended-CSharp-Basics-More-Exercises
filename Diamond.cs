...
task:
. Диамант
Да се напише програма, която прочита от конзолата цяло число N и чертае диамант, като в примерите по-долу. 
    Диамантът има ширина – 5 * n колони и височина – 3 * n + 2 реда. 
Вход
